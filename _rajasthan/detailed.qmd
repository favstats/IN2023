...
The chart below displays the most utilized targeting criteria by political parties on Meta, based on the amounts spent. The top targeting criteria predominantly use interests such as 'books' or 'politics.'
...
Among the detailed options offered by Meta, the chart below shows the most excluded target audiences per party. The ranking is based on the amounts spent. Most exclusion criteria are focused on interests such as 'books' or 'politics'.
