...
The following graphs illustrate how parties target different age groups and the percentage of budgets allocated to them.
...
The following graphs illustrate how parties target different genders and the percentage of budgets allocated to them.
...
The following graphs show how parties targeted different languages and the percentage of budgets allocated to them.
...
The following graphs depict how parties target various job sectors and types of education and the percentage of budgets allocated to them. The next graph focuses on educational levels.
...
The graphs below illustrate how parties target various education levels and the percentage of budgets allocated to each.
...
The following graphs reveal how political parties target different relationship statuses and the percentage of budgets allocated to them.
